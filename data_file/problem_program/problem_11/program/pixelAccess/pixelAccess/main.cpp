...
//画像ファイル
#define FILE_NAME "/Applications/MAMP/htdocs/aitpictures_20/data_file/problem_program/problem_16/image/cat.jpg"
...
//    //収縮
//    for (i=0; i<10; i++) {
//        cv::erode(dst_img, result_img, cv::Mat(), cv::Point(-1, -1), i);
